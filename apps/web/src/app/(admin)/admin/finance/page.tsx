    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="px-4 py-2 bg-[#3772FF] text-white rounded-lg flex items-center gap-2 hover:bg-[#2962FF]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#131722] rounded-xl p-6 border border-[#2B3139]">
          ...
          <div className="mt-4 flex items-center gap-2 text-sm">
            <span className="text-[#848E9C]">利润率: 63%</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#131722] rounded-xl border border-[#2B3139]">
        <div className="p-4 border-b border-[#2B3139] flex items-center justify-between">
          ...
          <a href="/admin/finance/withdrawals" className="text-[#3772FF] text-sm hover:underline">
            查看全部
          </a>
        </div>
