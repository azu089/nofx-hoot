...
export const MODEL_DISPLAY: Record<string, { name: string; provider: string; color: string }> = {
  'deepseek-chat': { name: 'DeepSeek Chat', provider: 'DeepSeek', color: '#3B82F6' },
  'deepseek-reasoner': { name: 'DeepSeek R1', provider: 'DeepSeek', color: '#1D4ED8' },
  'gpt-4o-mini': { name: 'GPT-4o Mini', provider: 'OpenAI', color: '#10B981' },
  'claude-haiku-4-5-20251001': { name: 'Claude Haiku 4.5', provider: 'Anthropic', color: '#D97706' },
  'gemini-2.5-flash': { name: 'Gemini 2.5 Flash', provider: 'Google', color: '#6366F1' },
  'qwen3.5-plus': { name: 'Qwen 3.5 Plus', provider: 'Alibaba', color: '#EC4899' },
  'grok-4-fast': { name: 'Grok 4 Fast', provider: 'xAI', color: '#F43F5E' },
  'kimi-k2.5': { name: 'Kimi K2.5', provider: 'Moonshot', color: '#8B5CF6' },
};
