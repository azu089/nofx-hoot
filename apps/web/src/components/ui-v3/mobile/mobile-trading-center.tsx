          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-[#12121A]/80 border border-[#1E1E2E] rounded-lg text-sm"
              >
              ...
              {showAccountDropdown && (
                <div className="absolute top-full right-0 mt-2 w-56 bg-[#12121A]/95 backdrop-blur-xl border border-[#1E1E2E] rounded-xl shadow-xl z-50 overflow-hidden">
      ...
      <div className="flex-1 overflow-auto pb-20">
        ...
        <div className="px-4 pb-3 flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-3 py-2 bg-red-500/10 border border-red-500/30 text-red-400 rounded-lg text-xs font-medium"
          >
        ...
        {/* Tab 导航 + 内容 - 统一卡片 */}
        <div className="px-4">
          <div className="bg-[#12121A]/80 border border-[#1E1E2E] rounded-xl overflow-hidden">
            {/* Tab 导航 */}
