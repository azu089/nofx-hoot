...
type Context struct {
	...
	// 策略配置引用，供 formatter 读取 ATR 自适应等动态阈值（nil 时使用固定阈值）
...
type Decision struct {
	...
	// Sized adjust actions: "reduce_long", "reduce_short", "scale_long", "scale_short" (use PartialPct)
