...
export const translations = {
  ...
  zh: {
    ...
    modelConfig: {
      ...
      payPerCall: '按调用付费',
      recommended: '推荐',
      claw402EntryDesc: 'Claw402 已弃用',
      claw402Connected: 'Claw402 已连接',
      claw402Unreachable: 'Claw402 不可用',
      otherApiEntry: '其他 API',
      otherApiEntryDesc: '使用自有 API Key',
      modelsConfigured: '已配置模型',
      invalidKeyPrefix: '密钥前缀错误',
      invalidKeyLength: '密钥长度错误',
      invalidKeyChars: '密钥字符错误',
      back: '返回',
      allModelsClaw: '全部模型（Claw）',
      allModelsUnified: '全部模型',
      dedicatedWallet: '专属钱包',
      exportKey: '导出密钥',
      fundStep1: '步骤 1',
      fundStep2: '步骤 2',
      fundStep3: '步骤 3',
