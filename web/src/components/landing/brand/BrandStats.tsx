                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-12 md:text-left">
                    {stats.map((stat, i) => (
                        ...
                        >
                            ...
                            <div className="text-3xl md:text-6xl font-medium text-white tracking-tighter mb-2 group-hover:scale-110 transition-transform duration-300 origin-left relative z-10">
                                {stat.value}
                            </div>
                            <div className="text-[10px] md:text-base font-medium text-zinc-400 md:text-black/60 uppercase tracking-widest bg-white/5 md:bg-white/20 inline-block px-2 py-1 rounded relative z-10">
                                {stat.label}
                            </div>
                        </motion.div>
                    ))}
