        ...
        <section id="features" className="py-24 bg-zinc-950 relative">
            <div className="max-w-[1920px] mx-auto px-6 lg:px-16">
                ...
                <div className="mb-16 border-l-4 border-nofx-gold pl-6">
                    <h2 className="text-4xl md:text-5xl font-medium text-white uppercase tracking-tighter mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
                    {features.map((f, i) => (
                        ...
                        >
                            ...
                            <h3 className="text-xl font-medium text-white mb-3 uppercase flex items-center gap-2">
                                {f.title}
                            </h3>
